...
#### Workaround for readr issue: https://github.com/tidyverse/readr/issues/364

df <- read_csv("https://raw.githubusercontent.com/rcatlord/GSinR_materials/master/4_tidy/banning_orders.csv", skip = 3)[,-c(3,6,9,12,15)] 
df <- df %>% slice(1:24)
